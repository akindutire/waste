...
<title>Waste Management|Reports</title>
...
<div id="templatemo_menu_wrapper">   
    ...
    <div id="templatemo_menu">
        <ul>
            ...
            <li><a href="chrpts.php" class="current">Charges Reports</a></li>
    ...
    <div id="templatemo_content">
      <div id="content_panel">
          ...
          <div id="column_w610">
            	...
            	<div class="header_01"><?php echo "History: "."<b style='color:green;'>".$_SESSION['cdr']."</b>"; ?>. </div>
          ...
          <div id="feedback" style="background:transparent; color:black; font-size:14px; padding:1px; margin:1% 32% 2px 32%; height:auto; width:350px; text-align:center; border-radius:3px; font-family:amble;"></div>
                ...
                <form action="../process/add.php" method="post" style="width:100%; margin-left:-20px;">
                		<input type="hidden" name="addid" value="2">
                        
                        <table align="center" style="text-align:center; padding:3px;">
                        
                        		<?php $me->getsum($_SESSION['cdr']); ?>
