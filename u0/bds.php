...
<title>Waste Management Buildings</title>
...
<div id="templatemo_menu_wrapper">   
    ...
    <div id="templatemo_menu">
        <ul>
            ...
            <li><a href="bds.php" class="current">Building</a></li>
    ...
    <div id="templatemo_content">
      <div id="content_panel">
          ...
          <div id="column_w610">
            	...
            	<div class="header_01">Building List</div>
          ...
          <div id="feedback" style="background:transparent; color:black; font-size:14px; padding:1px; margin:1% 32% 2px 32%; height:auto; width:350px; text-align:center; border-radius:3px; font-family:amble;"></div>
            ...
            <table align="center" style="width:100%; padding:5px; font-family:amble; font-size:14px; text-align:center; color:black;">
                <?php
